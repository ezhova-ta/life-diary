...
import com.example.lifediary.ui.woman_section.MenstruationDatesListFragment
...
object Screens {
    ...
    fun getMenstruationDatesListScreen() =
        FragmentScreen { MenstruationDatesListFragment.getInstance() }
}