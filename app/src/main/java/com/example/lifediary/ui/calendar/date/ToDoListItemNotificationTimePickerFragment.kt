...
class ToDoListItemNotificationTimePickerFragment : DialogFragment(), TimePickerDialog.OnTimeSetListener {
	companion object {
		const val TAG = "com.example.lifediary.ui.calendar.date.ToDoListItemNotificationTimePickerFragment"
		const val PICK_TIME_REQUEST_KEY = "com.example.lifediary.ui.calendar.date.PICK_TIME_REQUEST_KEY"
		const val PICKED_TIME_BUNDLE_KEY = "com.example.lifediary.ui.calendar.date.PICKED_TIME_KEY"
	}
