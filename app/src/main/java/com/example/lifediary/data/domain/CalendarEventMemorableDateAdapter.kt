...
class CalendarEventMemorableDateAdapter(private val memorableDate: MemorableDate) : CalendarEvent() {
	...
	override fun equals(other: Any?): Boolean {
		...
		other as CalendarEventMemorableDateAdapter
...
private fun MemorableDate.toCalendarEvent(): CalendarEvent {
	return CalendarEventMemorableDateAdapter(this)
}